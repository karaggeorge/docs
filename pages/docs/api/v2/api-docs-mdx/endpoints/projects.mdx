...
### Replace all Project Environment Variables
...
Add a production domain to the project by passing the project `id` in the URL and `domain` as request parameters. If the domain already exists on the project, fails with `400` status code.
