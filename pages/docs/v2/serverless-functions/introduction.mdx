...
export const meta = {
  ...
  lastEdited: '2019-10-18T05:16:28.000Z'
}

ZEIT Now deployments support various backend languages that you can deploy as Serverless functions.

Serverless functions are pieces of code that run on demand by reacting to events, such as an HTTP request.
...
slack commands, and more. For a conceptual overview of this new compute model, click [here](https://zeit.co/docs/v2/advanced/concepts/serverless-functions/#conceptual-model).
